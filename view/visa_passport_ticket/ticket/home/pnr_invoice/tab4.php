		...
		<div class="col-md-6 col-sm-12 col-xs-12 mg_bt_10_xs">
			...
			<div class="panel panel-default panel-body app_panel_style feildset-panel">
				...
				<div class="row">
					...
					<div class="col-sm-4 col-xs-12 mg_bt_10">
					<small>&nbsp;</small>
						<input type="text" id="other_taxes" name="other_taxes" placeholder="Airline convenience fee" title="Airline convenience fee" onchange="calculate_total_amount(this.id);validate_balance(this.id)">
