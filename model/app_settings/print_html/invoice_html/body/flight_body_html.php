        ...
        <table class="table table-bordered no-marg" id="tbl_emp_list" style="padding: 0 !important;">
          <thead>
            <tr class="table-heading-row">
              ...
              <th class="font_s_12">Airline taxes</th>
              <th class="font_s_12">Airline convenience fee</th>   
            </tr>
          </thead>
          <tbody>   
          <?php 
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="main_block inv_rece_calculation border_block">
        ...
        <div class="col-md-6"><p class="border_lt"><span class="font_5">AIRLINE TAXES + AIRLINE CONVENIENCE FEE</span><span class="float_r"><?php echo $currency_code.' '.($sq_fields['other_taxes'] + $sq_fields['yq_tax']); ?></span></p></div>   
